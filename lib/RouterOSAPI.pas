...
function TRosApiClient.Connect(const Hostname, Username, Password, Port: AnsiString;): Boolean;
begin
  FLastError := '';
  FSock.CloseSocket;
  FSock.LineBuffer := '';
...
function TRosApiClient.SSLConnect(const Hostname, Username, Password, Port: AnsiString;): Boolean;
begin
